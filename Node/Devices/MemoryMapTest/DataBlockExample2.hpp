...
/*--- Defaults ---*/
inline constexpr uint16_t DEFAULT_MEMORY_MAP_GEN_DATE = 64563U;
inline constexpr int32_t  DEFAULT_MEMORY_MAP_GEN_TIME = -655346L;
inline constexpr float    DEFAULT_MEMORY_MAP_CHECKSUM = 0.0001F;
