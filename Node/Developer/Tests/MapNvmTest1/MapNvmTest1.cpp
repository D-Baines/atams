/**
  ******************************************************************************
  * @file    MemoryMapNvmTest1.cpp
  *
  * @author  D. Baines
  *
  * @brief   Auto-generated file containing public function definitions
  *          for an Atams Memory Map with name: NvmTest1.
  *
  * @version v1.0
  ******************************************************************************
  * @attention
...
namespace Atams { namespace MapNvmTest1 {
...
static const NodeVarInfo_t s_varInfoList[Platform::NODE_NUMBER_OF_VARS]
{
  ...
  /* [BlockNvmTest::VAR_NVM_VAR_NAME_CHANGE_1] = */
  {
...
Atams::Error_t initUserDefaults(void)
{
  ...
  if (!error) error = Atams::setVar(BlockNvmTest::VAR_NVM_VAR_NAME_CHANGE_1, BlockNvmTest::DEFAULT_NVM_VAR_NAME_CHANGE_1);
...
const MemoryMap_t memoryMap 
{
  /* .sharedMap */
  {
    /* .genInfo     = */ MapNvmTest1::s_genInfo,
    /* .varInfoList = */ MapNvmTest1::s_varInfoList
  },
  /* initGenInfo      = */ MapNvmTest1::initGenInfo,
  /* initUserDefaults = */ MapNvmTest1::initUserDefaults,
};

} } /* End Namespace - Atams::MapNvmTest1 */
