...
enum Error_t: uint8_t
{
  ...
  ERROR_BUS_FULL                     = 21U,
  ERROR_BUS_EMPTY                    = 22U,
  ERROR_UPDATE_CYCLE_IN_PROGRESS     = 23U,
  ERROR_NEW_DATA_NOT_READY           = 24U,
  ERROR_ACK_NOT_RECEIVED             = 25U,
  ERROR_RESPONSE_TIMEOUT             = 26U,
  ERROR_NO_RESPONSE                  = 27U,
  ERROR_INIT_ORDER                   = 28U,
  ERROR_NVM_CHECKSUM                 = 29U,
  ERROR_GEN_INFO_MISMATCH            = 30U,
  ERROR_NVM_HEADER_LENGTH            = 31U,
