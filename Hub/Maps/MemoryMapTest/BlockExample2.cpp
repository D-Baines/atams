...
static Atams::Error_t initDefaults(DataBlock &blockToInit)
{
  ...
  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_WRITE_UINT8,
                                        BlockExample2::DEFAULT_WRITE_UINT8);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_WRITE_INT8,
                                        BlockExample2::DEFAULT_WRITE_INT8);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_READ_UINT8,
                                        BlockExample2::DEFAULT_READ_UINT8);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_READ_INT8,
                                        BlockExample2::DEFAULT_READ_INT8);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_WRITE_UINT16,
                                        BlockExample2::DEFAULT_WRITE_UINT16);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_WRITE_INT16,
                                        BlockExample2::DEFAULT_WRITE_INT16);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_READ_UINT16,
                                        BlockExample2::DEFAULT_READ_UINT16);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_READ_INT16,
                                        BlockExample2::DEFAULT_READ_INT16);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_WRITE_UINT32,
                                        BlockExample2::DEFAULT_WRITE_UINT32);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_WRITE_INT32,
                                        BlockExample2::DEFAULT_WRITE_INT32);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_READ_UINT32,
                                        BlockExample2::DEFAULT_READ_UINT32);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_READ_INT32,
                                        BlockExample2::DEFAULT_READ_INT32);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_WRITE_FLOAT,
                                        BlockExample2::DEFAULT_WRITE_FLOAT);

  if (!error) error = blockToInit.write(BlockExample2::VAR_ID_READ_FLOAT,
...
{
  /* .noOfDataMembers = */ BlockExample2::NUMBER_OF_VARS,
